...
<body class="social-snapship">
    <div>
        <h1>Snap-Ship</h1>
        <a href="./">
            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true" role="img" class="iconify iconify--emojione-v1" width="50rem" height="50rem" preserveAspectRatio="xMidYMid meet" viewBox="0 0 64 64">
