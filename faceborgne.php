...
<head>
    ...
    <title>Faceborgne</title>
</head>

<body class="social-faceborgne">
    <div>
        <h1>Faceborgne</h1>
        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true" role="img" class="iconify iconify--noto" width="50rem" height="50rem" preserveAspectRatio="xMidYMid meet" viewBox="0 0 128 128">
